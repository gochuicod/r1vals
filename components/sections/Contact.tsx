...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative w-full h-auto bg-black flex flex-col items-center justify-center py-12 lg:py-20 overflow-hidden"
    >
      {/* INNER CONTAINER */}
          ...
          <div className="flex flex-col gap-6 w-full">
            <div className="space-y-4">
              ...
              <p className="font-heading text-white text-center lg:text-start text-[16px] lg:text-[20px] opacity-90">
                Whether you have a powerhouse squad ready to dominate or you're
                a solo player looking to join the ranks, we want to hear from
                you.
              </p>
            </div>
            ...
            <div className="w-full flex justify-center items-center">
              <BrushedOfferContainer>
                <p className="flex flex-col lg:max-w-[700px] md:max-w-[500px] max-w-full font-heading font-normal tracking-[0%] text-[16px] lg:text-[20px] text-center text-white p-4">
                  <span className="font-bold text-[#FCC800]">
                    LIMITED OFFER:
                  </span>
                  Register your team early to unlock a Tiered Registration
                  Discount. Secure your spot before the bracket fills up!
                </p>
              </BrushedOfferContainer>
            </div>
            ...
            <div className="flex flex-col items-start p-0 gap-2 w-full">
              ...
              <ul className="flex flex-col items-start p-0 gap-0 w-full self-stretch text-[14px] antialiased font-heading">
                ...
                <li className="flex h-auto md:items-center items-start gap-2 text-white/80 leading-normal">
                  ...
                  <p>
                    <span>Priority Selection:</span> R1VALS is a curated
                    tournament; early applicants get first priority.
                  </p>
                </li>
                ...
                <li className="flex h-auto md:items-center items-start gap-2 text-white/80 leading-normal">
                  <span className="h-1 w-1 lg:mt-0 mt-2 rounded-full bg-white shrink-0" />
                  <p>
                    <span>Tiered Pricing:</span> The registration fee increases
                ...
                <li className="flex h-auto md:items-center items-start gap-2 text-white/80 leading-normal">
                  <span className="h-1 w-1 lg:mt-0 mt-2 rounded-full bg-white shrink-0" />
                  <p>
                    <span>Scout Visibility:</span> Get your team on the radar of
                    our global streaming partners and scouts early.
                  </p>
                </li>
              </ul>
            </div>
