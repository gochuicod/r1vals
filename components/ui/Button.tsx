...
const buttonVariants = cva(
  // Added duration-300 and ease-in-out for a more premium feel
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none font-black uppercase transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 font-body h-auto min-h-10',
  {
    variants: {
      variant: {
        ...
        yellow: 'bg-black border-2 border-[#FCC800] normal-case text-[#FCC800] hover:text-black hover:bg-[#FCC800] hover:border-black hover:scale-[1.05] font-bold text-center shadow-[0px_0px_15.6256px_#FCC800] will-change-transform transition-all duration-300 ease-in-out',      },
      size: {
