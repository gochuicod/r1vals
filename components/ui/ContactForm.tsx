...
const ContactForm = () => {
  ...
  return (
    <form className="flex flex-col items-start p-0 gap-[14px] w-full max-w-[742px] h-auto md:h-[259px] bg-transparent text-white font-['Inter']">
        {/* Place Polygon here */}
      ...
      <div className="flex flex-col md:flex-row items-start px-2 gap-2 w-full self-stretch flex-none">
        ...
        {/* Frame 143726082: Interests Section */}
        <div className="flex flex-col justify-center items-start p-2 gap-4 w-full md:w-[482px] flex-grow">
          ...
          <div className="flex flex-col items-start p-0 gap-2 w-full md:w-[466px]">
            <CheckboxOption 
              id="team"
        ...
        {/* Frame 143726099: Team & Social Section */}
