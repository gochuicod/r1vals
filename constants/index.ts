...
export const PRIVACY_POLICY_CONTENT: PolicySection[] = [
    ...
    subsections: [
      ...
      },
      {
        ...
        list: [
          ...
          { term: "Personal Data", def: "(or \"Personal Information\") is any information that relates to an identified or identifiable individual. We use \"Personal Data\" and \"Personal Information\" interchangeably unless a law uses a specific term." },
  ...
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        list: [
          { term: "", def: "Usage Data is collected automatically when using the Service." },
          { term: "", def: "Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic data." },
          { term: "", def: "When You access the Service by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device's unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internet browser You use, unique device identifiers and other diagnostic data." },
          { term: "", def: "We may also collect information that Your browser sends whenever You visit Our Service or when You access the Service by or through a mobile device." },
        ]
      }
    ]
  },
  {
    ...
    subsections: [
      {
        contentTitle: 'The Company may use Personal Data for the following purposes:',
        list: [
          { term: "", def: "To provide and maintain our Service, including to monitor the usage of our Service." },
          { term: "", def: "To manage Your Account: to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user." },
          { term: "", def: "For the performance of a contract: the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service." },
          { term: "", def: "To contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation." },
          { term: "", def: "To provide You with news, special offers, and general information about other goods, services and events which We offer that are similar to those that you have already purchased or inquired about unless You have opted not to receive such information." },
          { term: "", def: "To manage Your requests: To attend and manage Your requests to Us." },
          { term: "", def: "For business transfers: We may use Your Personal Data to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred." },
          { term: "", def: "For other purposes: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience." }
        ]
      },
      {
        contentTitle: 'We may share Your Personal Data in the following situations:',
        list: [
            { term: "", def: "With Service Providers: We may share Your Personal Data with Service Providers to monitor and analyze the use of our Service, to contact You." },
            { term: "", def: "For business transfers: We may share or transfer Your Personal Data in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company." },
            { term: "", def: "With Affiliates: We may share Your Personal Data with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us." },
            { term: "", def: "With business partners: We may share Your Personal Data with Our business partners to offer You certain products, services or promotions." },
            { term: "", def: "With other users: If Our Service offers public areas, when You share Personal Data or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside." },
            { term: "", def: "With Your consent: We may disclose Your Personal Data for any other purpose with Your consent." }
        ]
      },
    ],
  },
    ...
    subsections: [
        {
            ...
            list: [
                { term: "User Accounts:", def: "retained for the duration of your account relationship plus up to 24 months after account closure to handle any post-termination issues or resolve disputes." }
            ]
        },
        {
            contentTitle: "Customer Support Data",
            list: [
                { term: "Support tickets and correspondence:", def: "up to 24 months from the date of ticket closure to resolve follow-up inquiries, track service quality, and defend against potential legal claims" },
                { term: "Chat transcripts:", def: "up to 24 months for quality assurance and staff training purposes." }
            ]
        },
        {
            contentTitle: "Usage Data",
            list: [
                { term: "Website analytics data (cookies, IP addresses, device identifiers):", def: "up to 24 months from the date of collection, which allows us to analyze trends while respecting privacy principles." },
                { term: "Server logs (IP addresses, access times):", def: "up to 24 months for security monitoring and troubleshooting purposes." }
            ]
        },
        {
            content2: "Usage Data is retained in accordance with the retention periods described above, and may be retained longer only where necessary for security, fraud prevention, or legal compliance. We may retain Personal Data beyond the periods stated above for different reasons:",
            list: [
                { term: "Legal obligation:", def: "We are required by law to retain specific data (e.g., financial records for tax authorities)." },
                { term: "Legal claims:", def: "Data is necessary to establish, exercise, or defend legal claims." },
                { term: "Your explicit request:", def: "You ask Us to retain specific information." },
                { term: "Technical limitations:", def: "Data exists in backup systems that are scheduled for routine deletion." }
            ],
            extraText: "You may request information about how long We will retain Your Personal Data by contacting Us. When retention periods expire, We securely delete or anonymize Personal Data according to the following procedures:\n\nDeletion: Personal Data is removed from Our systems and no longer actively processed.\nBackup retention: Residual copies may remain in encrypted backups for a limited period consistent with our backup retention schedule and are not restored except where necessary for security, disaster recovery, or legal compliance.\nAnonymization: In some cases, We convert Personal Data into anonymous statistical data that cannot be linked back to You. This anonymized data may be retained indefinitely for research and analytics."
        }
    ]
  },
  {
    ...
    subsections: [
        {
            ...
            content2: "If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy."
        },
        {
            contentTitle: "Law enforcement",
            content2: "Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency)."
        },
        {
            contentTitle: "Other legal requirements",
            content2: "The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:",
            list: [
                { term: "", def: "Comply with a legal obligation" },
                { term: "", def: "Protect and defend the rights or property of the Company" },
                { term: "", def: "Prevent or investigate possible wrongdoing in connection with the Service" },
                { term: "", def: "Protect the personal safety of Users of the Service or the public" },
